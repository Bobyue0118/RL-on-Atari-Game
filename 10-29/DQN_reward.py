...
class DQN:
    ...
    def create_model(self):
        ...
        model.add(Dense(self.env.action_space.n, activation='linear',  kernel_initializer="he_uniform"))# self.env.action_space.n = 4
...
def main():
    ...
    for episode in range(episodes):
        ...
        for i in (range(trial_len)):
            ...
            # print("******************",reward)
            if i < 33:
                prev_state_.append(prev_state)
                action_.append(action)
                reward_.append(reward)
                current_state_.append(current_state)
                done_.append(done)
            else:
                prev_state_.append(prev_state)
                action_.append(action)
                ...
                dqn_agent.remember(prev_state_[0], action_[0], reward, current_state_[0], done_[0])
